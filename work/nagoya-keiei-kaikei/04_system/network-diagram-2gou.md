...
1. **VLAN分離なし＝完全確定**。BS-GS2008P(.201)の画面で **VLAN ID 1のみ・全ポートStatic Untagged・PVID全1・Taggedゼロ**。RTX(単一192.168.21.0/24)・AP・SWの3層すべてで分離なし。職員/生徒/ゲスト混在＝**最大の改善ポイント（N-02でタグVLAN分離）**。
