...
| 生徒AP | **.7.241** | **BUFFALO WAPM-1166D（＝2F机上シャドー.200と同一型番）・login `admin/Sbm3241`**。OUI 88:57:EE＝.200(C9:3E:40)の兄弟機。MAC→credentials。SSID=**NAMATESC01**。**FW 1.4.3**（★.200は1.12.1＝同型でFW不統一）・命名既定`AP8857EEC981E0`・有線#1=100M全二重Untagged/1。**★NTP無効・内蔵時計2013/9/1（.200シャドーと同じ約13年ズレ）** |
...
- 留意：.7.241も**BUFFALOのAP管理PWが`Sbm3241`（.200シャドー機と同一・推測しやすい弱PW）**＝**全AP共通の弱PW運用**の疑い。N-02で全機PW刷新の根拠。
