...
| 要確認 | .2.6(XAC Automation＝決済/出席端末?)・.2.7(Redirect Page/MAC=0＝FGリダイレクト?)・.2.9(AzureWave) | 正体未確定 |
...
4. ~~**教員VLAN1 / 生徒VLAN7・8の分離**：物理かタグか~~ ✅**確定：RTXのポートベース分割（lan1.1-4=vlan1 / 1.5-6=vlan7 / 1.7-8=vlan8）＋secure filterで 2F↔7F/8F遮断・7F-8F間は可**。残：5Fコア(BS-GS2016P)が各VLANをどの物理ポートで受け、どのriserケーブルがどのVLANか（色トレース）。
